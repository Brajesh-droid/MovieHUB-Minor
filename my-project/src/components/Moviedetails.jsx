...
import Loding from "./Loding"// Corrected spelling of Loading component

const Moviedetails = () => {
    document.title = "SCSDB | Movie Details"; // Set document title
    ...
    useEffect(() => {
        dispatch(asyncloadmovie(id));  // Fetch movie details when the component mounts
        return () => {
            dispatch(removemovie());  // Cleanup: remove movie details when the component unmounts
        };
    }, [id, dispatch]);  // Added dependencies for useEffect
